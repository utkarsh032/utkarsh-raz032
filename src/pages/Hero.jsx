...
const Hero = () => {
  return (
    <section id="hero" className="relative w-full h-screen mx-auto max-w-7xl text-white">
      <div className="absolute inset-0 top-[100px] flex flex-col md:flex-row-reverse md:items-center text-center md:text-start px-4">
        ...
        <div className="w-full md:w-1/2 mb-8">
          ...
          >
            Creating seamless digital journeys through modern web technologies and thoughtful design.
          </motion.p>
          ...
          >
            <a
              href={Resume}
              download
              className="bg-[#A11143] text-neutral-300 rounded-full px-6 py-3 text-lg font-medium shadow-md flex items-center gap-2 transition-all duration-300 transform "
            >
              Resume
              <GoDownload />
            </a>
